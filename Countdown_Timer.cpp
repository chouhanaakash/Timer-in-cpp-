...
{   char v = 186; // vertical
	...
	gotoxy((width/2)+x-20, y); cout<<"T I M E R   P R O G R E S S";
...
{   system("cls");
	...
	{   system("cls");
		...
		cout<<"=                T I M E R                  ="<<endl;
		cout<<"=                                           ="<<endl;
		cout<<"=        M A D E   B Y   A A K A S H        ="<<endl;
		cout<<"============================================="<<endl<<endl;
		...
		while(1){
			...
			//50 milisecond processing time is deducted.
			Sleep(1000);
			...
			gotoxy(10,22); cout<<"DO YOU WANT TO USE WATCH AGAIN (Y/N): ";
			op = getch();
		}while(op=='y' || op=='Y');
return 0;
}
